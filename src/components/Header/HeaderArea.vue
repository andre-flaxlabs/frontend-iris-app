...
<template>
  <header
    class="sticky top-0 z-5 flex w-full bg-white drop-shadow-md dark:bg-slate-900 dark:drop-shadow-none"
  >
    <div class="flex flex-grow items-center justify-between py-4 px-4 shadow-2 md:px-6 2xl:px-11">
      <div class="flex items-center gap-2 sm:gap-4 lg:hidden">
        <!-- Hamburger Toggle BTN -->
        <button
          class="z-10 block rounded-sm border border-stroke bg-white p-2 shadow-sm dark:bg-gray-800 dark:border-gray-700 lg:hidden"
          @click="
            () => {
        ...
        <router-link class="block flex-shrink-0 lg:hidden" to="/">
          <!-- <img src="../../assets/flaxlabslogo.png" alt="Logo" /> -->
        </router-link>
      </div>
