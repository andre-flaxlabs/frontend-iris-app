...
<template>
  <li>
    <router-link
      :to="item.route"
      class="group relative flex items-center gap-3 rounded-sm py-2 px-4 font-medium text-white duration-300 ease-in-out hover:bg-slate-800 hover:backdrop-blur-lg dark:hover:bg-meta-4"
      @click.prevent="handleItemClick"
      :class="{
        'bg-slate-700 dark:bg-slate-800': sidebarStore.page === item.label
      }"
    >
